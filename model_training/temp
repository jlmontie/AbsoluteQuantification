...
    if not os.path.exists(os.path.join(config['Paths']['OutputDir'], config['Paths']['ModelSubDir'])):
        os.mkdir(os.path.join(config['Paths']['OutputDir'], config['Paths']['ModelSubDir']))
